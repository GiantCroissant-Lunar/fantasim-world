...
public class EventStoreContractTests
{
    ...
    public void EventStore_Interface_IsInCorrectNamespace()
    {
        ...
        // Assert - Should be in FantaSim.Geosphere.Plate.Topology.Contracts.Events namespace
        Assert.Equal("FantaSim.Geosphere.Plate.Topology.Contracts.Events", interfaceType.Namespace);
    }
